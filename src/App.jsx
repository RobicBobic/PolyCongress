      ...
      <header className={`header ${isScrolled ? 'scrolled' : ''}`}>
        <div className="container header-content">
          ...
          <nav className={`nav ${mobileMenuOpen ? 'open' : ''}`}>
            <a onClick={() => scrollToSection('markets')} className="nav-link">Markets</a>
